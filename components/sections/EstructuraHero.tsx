  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[url('/images/estructura/consejo-nacional.jpg')] bg-cover bg-center bg-no-repeat opacity-10" />
      </div>
        ...
        <ScrollReveal direction="fade" delay={50}>
          <div className="mb-8">
            <div className="inline-flex items-center px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-sm font-medium mb-8">
              <Crown className="w-4 h-4 mr-2 text-jmv-gold" />
